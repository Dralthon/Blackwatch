...
encryptionFull = encryption1 + encryption2 + encryption3

print(encryptionFull)
...
for test in range(0, len(encryptionFull) - 1):
	for letter in range(test + 1, len(encryptionFull) - 1):
		testLetter = encryptionFull[test]
		if testLetter == encryptionFull[letter]:
			alphabet[testLetter] = alphabet[testLetter] = str(letter - test) + ", "
